...
beautiful.init("~/.config/awesome/themes/qhe/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- QHE Mod Rename Taglist/Workspaces
    -- Each screen has its own tag table.
    awful.tag({ "Main", "Web", "Email", "Office", "Empty"}, s, awful.layout.layouts[1])
