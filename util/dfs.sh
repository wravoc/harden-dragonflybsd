...
if [ $ifconfig_check = "wlan0" ] && [ $router_check = "associated" ] 
then
...
if [ $battery_percentage -ge 65 ] && [ $power_type -ne 1 ]
then
    echo "                                                                  ${white}\xF0\x9F\x94\x8B${end}   $green ${battery_percentage}%${end}"
    echo "                                                                        ${battery_life}mins"
elif [ $battery_percentage -ge 65 ] && [ $power_type -eq 1 ]
then
    echo "                                                                  ${white}\xF0\x9F\x94\x8B${end}   $green ${battery_percentage}%${end}"
elif [ $battery_percentage -lt 65 ] && [ $battery_percentage -ge 25 ] && [ $power_type -ne 1 ] 
then
    echo "                                                                  ${white}\xF0\x9F\x94\x8B${end}   $yellow ${battery_percentage}%${end}"
    echo "                                                                        ${battery_life}mins"
elif [ $battery_percentage -lt 65 ] && [ $battery_percentage -ge 25 ] && [ $power_type -eq 1 ] 
then
    echo "                                                                  ${white}\xF0\x9F\x94\x8B${end}   $yellow ${battery_percentage}%${end}"
elif [ $battery_percentage -lt 25 ] && [ $power_type -ne 1 ] 
then
    echo "                                                                  ${white}\xF0\x9F\x94\x8B${end}   $red ${battery_percentage}%${end}"
    echo "                                                                        ${battery_life}mins"
elif [ $battery_percentage -lt 25 ] && [ $power_type -eq 1 ] 
then
    echo "                                                                  ${white}\xF0\x9F\x94\x8B${end}   $red ${battery_percentage}%${end}"
elif [ $battery_percentage -le 10 ] || [ $battery_life -le 10 ] && [ $power_type -ne 1 ]
then
    echo "                                                                  ${white}\xF0\x9F\x94\x8B${end}   $red ${battery_percentage}%${end}"
    echo "                                                                        ${battery_life}mins ${red}\xE2\x8C\x9B${end}"
elif [ $battery_percentage -le 10 ] || [ $battery_life -le 10 ] && [ $power_type -eq 1 ]
then
    echo -en '\a' > /dev/ttyv0
    echo -en '\a' > /dev/ttyv0
    echo "                                                                  ${white}\xF0\x9F\x94\x8B${end}   $red ${battery_percentage}%${end}"
